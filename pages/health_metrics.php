...
<div id="page_box">
    ...
    <div id="moodPage" class="page hidden">
      <div class="inner_box">
        ...
        <div class="mood-icons">
          <img src="<?php echo SITE_URL; ?>assets/images/mood-small_icon1.png" data-angle="191" data-color="#ff4d4d" onclick="updateMood(this)">
          <img src="<?php echo SITE_URL; ?>assets/images/mood-small_icon2.png" data-angle="260" data-color="#ff8c1a" onclick="updateMood(this)">
          <img src="<?php echo SITE_URL; ?>assets/images/mood-small_icon3.png" data-angle="336" data-color="#ffd700" onclick="updateMood(this)">
          <img src="<?php echo SITE_URL; ?>assets/images/mood-small_icon4.png" data-angle="50" data-color="#9acd32" onclick="updateMood(this)">
          <img src="<?php echo SITE_URL; ?>assets/images/mood-small_icon5.png" data-angle="118" data-color="#32cd32" onclick="updateMood(this)">
        </div>
  ...
  <script>
    ...
    function updateSleep() {
      ...
      document.getElementById('sleepTime').textContent = `${hours.toString().padStart(2, '0')} : ${minutes.toString().padStart(2, '0')}`;
    }
    ...
    function updateMood(element) {
            ...
            let pointer = document.getElementById('moodPointer');
    ...
    function updateEnergyProgress(value) {
        ...
        slider.style.background = `linear-gradient(to right, #88ca03 ${percentage}%,rgba(0, 0, 0, 0) ${percentage}%)`;
    }
